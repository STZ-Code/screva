...
export function RunnerButton({
	...
	return (
		<motion.button
			...
			whileTap="tap"
			className={clsx(
				'bg-cyan-400 w-72 2xl:w-80 py-4 text-zinc-100 rounded-sm text-4xl font-bebas relative overflow-hidden transition-colors cursor-pointer',
				{
		...
		>
			...
			<div>
				<span
					className={clsx(
						'absolute bottom-0 right-0 border-b-72 border-b-cyan-500/80 border-l-36 border-l-transparent border-r-0 border-r-transparent w-16 2xl:w-20',
						{
							'border-b-cyan-500/80': variant === 'event',
							'border-b-slate-700/80': variant === 'result',
						},
				...
				<span
					className={clsx(
						'w-[94px] border-b-12 absolute right-3 2xl:right-7 top-8 border-l-[6px] border-l-transparent border-r-[6px] rotate-[-64deg] border-r-transparent',
						{
							'border-b-cyan-500/80': variant === 'event',
							'border-b-slate-700/80': variant === 'result',
						},
				...
				<span
					className={clsx(
						'w-[64px] border-b-[6px] absolute right-8 2xl:right-12 top-4 border-l-[6px] border-l-transparent border-r-[6px] rotate-116 border-r-transparent',
						{
							'border-b-cyan-500/80': variant === 'event',
							'border-b-slate-700/80': variant === 'result',
						},

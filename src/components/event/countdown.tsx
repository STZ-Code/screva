...
export function Countdown() {
	return (
		<Box className="items-center justify-center gap-4 cursor-default rounded-none 2xl:rounded-2xl">
			...
			>
				...
				<span className="2xl:text-sm text-xs font-medium uppercase tracking-wider">

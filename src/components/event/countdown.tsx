...
export function Countdown() {
	return (
		<Box className="items-center justify-center gap-4 py-4 cursor-default rounded-none xl:rounded-2xl">
			...
			>
				...
				<span className="xl:text-sm text-xs font-medium uppercase tracking-wider">

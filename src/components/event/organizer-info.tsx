...
export function OrganizerInfo() {
	return (
		<Box className="gap-4">
			<h3 className="text-2xl font-bold text-zinc-100">Organizador</h3>

			<div className="flex gap-2 items-center">
				<div className="w-16 h-16 relative">
					<Image src={organizerImg} alt="Logomarca do organizador" fill />
				</div>
				<span className="font-bold text-xl text-zinc-100">SESC PERNAMBUCO</span>
			</div>
			...
			<Button variant="outline">Falar com Organizador</Button>
		</Box>
	)
}

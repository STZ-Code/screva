										...
										renderItem={(row: STZRow<Payment>) => (
											...
											>
												<Accordion.Trigger className="w-full px-4 py-6 hover:no-underline rounded-none cursor-pointer data-[state=open]:bg-neutral-800 hover:bg-neutral-800 transition-colors">
													<div className="flex gap-8 2xl:flex-row flex-col justify-between w-full 2xl:pr-16">
														<div className="flex gap-8 2xl:flex-row flex-col">
															<div className="flex gap-8">
																<div className="flex flex-col gap-4">
																	<Tag className="bg-emerald-800 text-emerald-300 2xl:text-sm text-xs">
																		Novo evento
																	</Tag>
																...
																<div className="flex gap-16">
																	<div className="flex flex-col gap-4">
																		<h2 className="font-bold 2xl:text-2xl text-xl text-zinc-50">
																			1ª Evento ITAIM RUN
																		</h2>
												...
												<Accordion.Content className="border-t px-4 py-6 text-sm border-zinc-700 bg-dashboard-header flex flex-col gap-5">
													...
													<div className="flex justify-between flex-col 2xl:flex-row gap-6 2xl:gap-0">
														<button
															type="button"
														...
														<div className="flex gap-4">
															...
															<ConfirmEventSheet>
																<Sheet.Trigger asChild>
																	<Button
																		type="submit"
																		className="h-12 w-52 font-semibold px-8 rounded-none cursor-pointer bg-cyan-600 outline-none 2xl:w-56 normal-case"
																	>
																		Confirmar evento
																	</Button>
																</Sheet.Trigger>

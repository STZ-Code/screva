										...
										renderItem={(row: STZRow<Payment>) => (
											...
											>
												<Accordion.Trigger className="w-full rounded-none px-6 hover:no-underline cursor-pointer data-[state=open]:bg-neutral-800 hover:bg-neutral-800 transition-colors">
													<div className="flex w-full 2xl:flex-row flex-col 2xl:gap-0 gap-8">
														<div className="flex 2xl:gap-10 gap-6 2xl:w-1/2 w-full">
												...
												<Accordion.Content className="border-t px-4 py-4 text-sm text-zinc-700 bg-neutral-800/40 flex 2xl:flex-row flex-col gap-8">
													...
													<div className="flex flex-col gap-8">
														<div className="flex flex-col gap-2">
															...
															<div className="flex 2xl:gap-16 gap-4">
																<div className="flex">
																	<Image
																		src={creditCardImg}
																		alt="mastercard"

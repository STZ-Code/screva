	...
	return (
		<div className="flex-1 flex flex-col p-6 gap-6">
			...
			<div className="flex gap-4 items-start justify-between">
				<div className="flex gap-4">
					...
					<div className="flex flex-col gap-4">
						<div className="flex gap-2 items-center">
							...
							<StatusTag.Root className="flex 2xl:hidden">
								<StatusTag.Icon
				...
				<StatusTag.Root className="hidden 2xl:flex">
					<StatusTag.Icon
						icon={CheckCircleIcon}
						weight="fill"
						className="text-emerald-500 size-4"
...
export function KitDeliveryAthleteDetails() {
	return (
		<div className="bg-neutral-900 min-h-200 2xl:w-114 w-full rounded border border-zinc-800 h-full">
			{/* <AthleteDetailsEmpty /> */}
			<AthleteDetails />
		</div>
	)

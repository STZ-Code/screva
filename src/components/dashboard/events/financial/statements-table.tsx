	...
	return (
		...
		>
			<div className="flex items-center justify-between mb-2 2xl:flex-row flex-col-reverse 2xl:gap-0 gap-4">
				...
				<div className="flex items-center gap-2 2xl:w-fit w-full 2xl:flex-row flex-row-reverse">
					<Dropdown.Root>
						<Dropdown.Trigger className="px-3.5 border border-zinc-300 rounded">
							<Dropdown.Label className="flex items-center gap-3 cursor-pointer hover:bg-zinc-300/10 transition-colors">
								...
								<p className="hidden 2xl:block">Exportar</p>
							</Dropdown.Label>
						</Dropdown.Trigger>
					...
					<CreateFinancialReleaseSheet>
						<Sheet.Trigger asChild>
							<Button
								type="submit"
								className="py-2 outline-none h-fit px-6 2xl:w-56 flex-1 w-full normal-case font-semibold flex gap-2"
							>

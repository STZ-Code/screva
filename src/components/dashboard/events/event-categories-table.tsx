...
import { Avatar, type STZColumnDef, type STZRow, Table } from '@stz-code/ui'
			...
			<Accordion.Root type="multiple">
				<Table.Accordion
					...
					renderItem={(row: STZRow<Payment>) => (
						...
						>
							<Accordion.Trigger className="w-full px-4 py-6 hover:no-underline rounded-none cursor-pointer hover:bg-neutral-800 transition-colors font-bebas text-2xl">
							...
							<Accordion.Content className="border-t p-6 text-sm border-zinc-700 bg-dashboard-header flex flex-col gap-5">
								...
								<div className="flex flex-col gap-2">
									<span className="text-lg font-semibold">Detalhes do kit</span>
									...
									<div className="flex gap-20">
										...
										<div className="flex flex-col pl-3 border-l-4 border-zinc-700">
											<span className="text-zinc-400">Vendas até</span>
											<strong className="font-semibold text-lg text-zinc-200">
												13/04/2026
											</strong>
										</div>
									...
									<div className="mt-2">
										<div className="flex flex-col pl-3 border-l-4 border-zinc-700">
											...
											<strong className="font-semibold text-base text-zinc-200">
												Medalha de participação (ao concluir a prova), Número de
												peito, Chip de cronometragem, Alfinetes, Pulseira de
												Identificação, Brindes dos Patrocinadores, Manual do
												Atleta.
											</strong>
										</div>
									</div>

...
import { CaretDoubleUpIcon, InstagramLogoIcon, LinkedinLogoIcon } from '@phosphor-icons/react'
  ...
  return (
    <footer className="relative border-t-2 border-t-zinc-700 overflow-hidden">
      ...
      <motion.div
        ...
        className="p-12 flex justify-between flex-col gap-12 md:flex-row md:gap-0 relative z-20"
      >
        <motion.div variants={itemVariants} className="w-full md:w-1/4 gap-8 flex flex-col">
          ...
          <div className="flex gap-4">
            {[
              { Icon: InstagramLogoIcon, href: 'https://www.instagram.com/stzcode' },
              { Icon: LinkedinLogoIcon, href: 'https://www.linkedin.com/company/stzcode/', weight: 'fill' as const },
            ].map((social, index) => (
              <motion.a
                key={index}
                href={social.href}
        ...
        <div className="md:w-1/2 flex flex-col sm:flex-row gap-16 md:justify-end">
          <motion.nav variants={itemVariants}>
            <span className="text-zinc-100 font-bold uppercase tracking-widest text-xs">Navegação</span>
            <ul className="flex flex-col gap-3 mt-4">
              {['Home', 'Eventos', 'Resultados', 'Anuncie um Evento', 'Contato'].map((item) => (
                <li key={item}>
                  <motion.a
          ...
          <motion.nav variants={itemVariants}>
            <span className="text-zinc-100 font-bold uppercase tracking-widest text-xs">Legal</span>
            <ul className="flex flex-col gap-3 mt-4">

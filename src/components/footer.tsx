		...
		<>
			...
			<footer className="relative overflow-hidden border-t-2 border-t-zinc-700">
				<motion.div
					...
					viewport={{ once: true }}
					className="pointer-events-none absolute -top-28 right-16 z-10 lg:right-56"
				>
				...
				>
					<motion.div
						...
						className="flex w-full flex-col gap-8 lg:w-1/4"
					>
					...
					<div className="hidden flex-col gap-16 md:w-1/2 sm:flex-row md:justify-end lg:flex">
